...
$configs =  array(
    ...
    //'配置项'=>'配置值'
    'APP_GROUP_LIST' => 'Admin,Shangjia,Mobile,Delivery,Store,App,Wuye,Mcenter,Member,Pchome,Fenzhan,Weixin,Worker,Communitys', //项目分组设定
    ...
    //系统配置
    'DEFAULT_TIMEZONE'      => 'Pacific/Auckland',	// 默认时区
