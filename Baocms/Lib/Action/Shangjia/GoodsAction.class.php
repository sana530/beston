...
class GoodsAction extends CommonAction
{
    ...
    public function weidian()
    {
        ...
        if ($this->isPost()) {
            $data = $this->checkFields($this->_post('data', false), array('weidian_name', 'addr', 'city_id', 'area_id', 'cate_id', 'business_time','express_price', 'details', 'pic', 'logo', 'lng', 'lat', 'reg_time'));
            if (empty($weidian)) {
            ...
            $data['express_price'] = floatval($data['express_price']);
            if (empty($data['express_price'])) {
                $this->baoError('配送运费不能为空');
            }
