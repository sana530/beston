...
class BookingAction extends CommonAction {
    ...
    private function createCheck() {
        $data = $this->checkFields($this->_post('data', false), array('shop_name', 'addr', 'city_id', 'area_id','business_id',
            'price','mobile','deposit','tel', 'details', 'photo', 'lng', 'lat','business_time', 'stime', 'ltime'));
    ...
    public function catecreate() {die;
        if ($this->isPost()) {
    ...
    public function catedelete($cate_id = 0) {die;
    ...
    public function menucreate() {die;
        if ($this->isPost()) {
    ...
    public function menudelete($menu_id = 0) {die;
