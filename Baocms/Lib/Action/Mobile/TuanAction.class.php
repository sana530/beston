        ...
        if ($code == 'wait') {
            ...
            if (D('Tuanorder')->save(array('order_id' => $order_id, 'status' => '-1'))) {
                ...
                if (isCnMobile($this->member['mobile'])) {
                    D('Sms')->CnSms($this->_CONFIG['site']['sitename'], 'sms_tuan_user', $this->member['mobile'], array(
                        'code' => $codestr,
                    ...
                    if ($this->_CONFIG['sms']['dxapi'] == 'bu') {
                        D('Sms')->BuSms($this->_CONFIG['site']['sitename'], 'sms_tuan_user', $this->member['mobile'], array(
                            'code' => $codestr,
                            'user' => $this->member['nickname'],
                            'shop_name' => $tuan['title']
                        ));
