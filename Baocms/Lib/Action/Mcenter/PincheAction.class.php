...
class PincheAction extends CommonAction{
    ...
    private $edit_fields = array('cate_id', 'city_name','area_name','community_id', 'user_id','photo', 'start_time', 'start_time_more', 'toplace', 'middleplace', 'num_1', 'num_2', 'num_3', 'num_4', 'mobile','addr', 'details');
