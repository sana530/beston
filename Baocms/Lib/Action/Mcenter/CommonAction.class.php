...
class CommonAction extends Action
{
    ...
    protected function _initialize()
    {
        ...
        $this->uid = (int) getuid();
        if (empty($this->uid)) {
            if (strpos($_SERVER['REQUEST_URI'],"/mcenter/money/transfer/token/") !== false){
        ...
        $this->assign('sign_day', $sign_day = D('Usersign')->where(array('user_id' => $this->uid, 'last_time' => array(array('ELT', NOW_TIME), array('EGT', $bg_time))))->select());
        //查询通知结束
