...
class  LifeAction extends  CommonAction{
   ...
   protected $lifecate = array();
    ...
    public function index(){
        ...
        $this->assign('urgent', $this->_CONFIG['shop']['life']['urgent']);
        $this->assign('top', $this->_CONFIG['shop']['life']['top']);
        $this->display(); // 输出模板
    }
    public function urgent(){
        ...
        $money = $mday * $this->_CONFIG['shop']['life']['urgent'];
    ...
    public function top(){
        ...
        $money = $mday * $this->_CONFIG['shop']['life']['top'];
        if($this->member['money'] < $money){
            $this->fengmiMsg('余额不足',U('mcenter/money/index'));
        }
