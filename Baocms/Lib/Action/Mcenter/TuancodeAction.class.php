...
class TuancodeAction extends CommonAction
{
    ...
    public function sms($code_id)
    {
        ...
        if ($detail = D('Tuancode')->find($code_id)) {
            ...
            if (isCnMobile($users['mobile'])) {
                D('Sms')->CnSms($this->_CONFIG['site']['sitename'], 'sms_tuan_user', $users['mobile'], array('code' => $code, 'user' => $users['nickname'], 'shop_name' => $shop['shop_name']));
            } elseif (isMobile($users['mobile'])) {
                if ($this->_CONFIG['sms']['dxapi'] == 'bu') {
                    D('Sms')->BuSms($this->_CONFIG['site']['sitename'], 'sms_tuan_user', $users['mobile'], array('code' => $code, 'user' => $users['nickname'], 'shop_name' => $shop['shop_name']));
                    ...
                    D('Sms')->sendSms('sms_tuancode', $users['mobile'], array('user' => $users['nickname'], 'code' => $code, 'price' => $price, 'shop_name' => $shop['shop_name']));
                }
            }
