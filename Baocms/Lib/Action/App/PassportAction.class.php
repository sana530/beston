...
class PassportAction extends CommonAction{
    ...
    public function sendsms() {
        ...
        if ($this->_CONFIG['sms']['dxapi'] == 'bu') {
            D('Sms')->BuSms($this->_CONFIG['site']['sitename'], 'sms_code', $mobile, array('code' => $randstring));
        } elseif ($this->_CONFIG['sms']['dxapi'] == 'dy') {
            D('Sms')->DySms($this->_CONFIG['site']['sitename'], 'sms_code', $mobile, array('code' => $randstring));
        } else {
