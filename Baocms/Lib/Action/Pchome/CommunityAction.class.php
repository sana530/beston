...
class CommunityAction extends CommonAction {
    ...
    public function feedback() {
        ...
        if ($this->isPost()) {
            ...
            $obj = D('Feedback');
            if ($obj->add($data)) {
                $this->niuSuccess('反馈提交成功', U('community/detail', array('community_id' => $community_id)));
            }
            $this->niuError('操作失败！');
        } else {
            $this->assign('detail', $detail);
    ...
    public function join() {
        ...
        if (D('Communityusers')->add($data)) {
            $this->niuSuccess('欢迎您加入'.$detail['name'].'小区！', U('community/detail', array('community_id' => $community_id)));
        }
    ...
    public function out() {
        ...
        if (D('Communityusers')->where($map)->delete()) {
            $this->niuSuccess('您已经退出'.$detail['name'].'小区！', U('community/detail', array('community_id' => $community_id)));
        }
    ...
    public function post() {
        ...
        if ($this->isPost()) {
            ...
            $data['create_ip'] = get_client_ip();
            if ($obj->add($data)) {
                $this->niuSuccess('发布帖子成功', U('community/tieba',array('community_id' => $data['community_id'])));
            }
            $this->niuError('操作失败！');
        } else {
            $this->niuError('操作失败！');
   ...
   public function tie($post_id) {
    ...
    public function reply() {
        ...
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                ...
                $this->niuSuccess('发布帖子成功', U('community/tie',array('post_id' => $data['post_id'])));
            }
    ...
    public function zan() {
        ...
        $this->niuSuccess('恭喜您，点赞成功！', U('community/tie', array('post_id' => $post_id)));
    }
