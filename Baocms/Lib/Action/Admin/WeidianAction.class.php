...
class WeidianAction extends CommonAction {
    ...
    private $edit_fields = array('user_id', 'cate_id', 'city_id', 'area_id', 'weidian_name', 'addr', 'logo', 'pic', 'business_time','express_price','rate','details', 'lng', 'lat', 'cate_id', 'audit', 'city_id', 'area_id', 'audit', 'update_time');
