...
class MarketAction extends CommonAction {
    ...
    private $create_fields = array('city_name','area_name', 'business_name', 'market_name', 'logo', 'photo', 'addr', 'summary', 'tel', 'contact', 'type1', 'type2', 'type3', 'type4', 'type5', 'type6', 'tags', 'business_time', 'near', 'orderby', 'lng', 'lat');
    private $edit_fields = array('city_name','area_name', 'business_name', 'market_name', 'logo', 'photo', 'addr', 'summary', 'tel', 'contact', 'type1', 'type2', 'type3', 'type4', 'type5', 'type6', 'tags', 'business_time', 'near', 'orderby', 'lng', 'lat');
    ...
    private function createCheck() {
        ...
        if (!isPhone($data['tel']) && !isMobile($data['tel']) && !isCnMobile($data['tel'])) {
