...
class DeliveryAction extends CommonAction {
    ...
    private $create_fields = array('user_id', 'first_name', 'last_name', 'identity', 'license', 'license_version', 'passport', 'email', 'mobile', 'addr', 'photo_id', 'is_zhanzhang');
    private $edit_fields = array('user_id', 'first_name', 'last_name', 'identity', 'license', 'license_version', 'passport', 'email', 'mobile', 'addr', 'photo_id', 'is_zhanzhang');
    ...
    private function createCheck()
    {
        ...
        $data['is_zhanzhang'] = intval($data['is_zhanzhang']);
        if (empty($data['email'])) {
    ...
    private function editCheck()
    {
        ...
        if(D('Delivery')->where(array('mobile'=>$data['mobile'], 'user_id'=>array('neq',$data['user_id'])))->find()){
            $this->baoError('重复的手机号！');
        }
        $data['addr'] = htmlspecialchars($data['addr']);
        if (empty($data['addr'])) {
