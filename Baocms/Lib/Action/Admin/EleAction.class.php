...
class EleAction extends CommonAction {
    ...
    private $create_fields = array('shop_id', 'cate', 'distribution', 'is_open', 'is_pay', 'is_fan', 'fan_money', 'is_new', 'full_money', 'new_money', 'logistics', 'since_money', 'sold_num', 'month_num', 'intro', 'audit', 'orderby', 'rate', 'is_delivery', 'order_ready');
    private $edit_fields = array('shop_name', 'is_open', 'cate', 'distribution', 'is_pay', 'is_fan', 'fan_money', 'is_new', 'full_money', 'new_money', 'logistics', 'since_money', 'sold_num', 'month_num', 'intro', 'orderby', 'audit', 'rate', 'is_delivery', 'order_ready');
    ...
    private function createCheck() {
        ...
        $data['order_ready'] = (int) $data['order_ready'];
        $data['is_delivery'] = (int) $data['is_delivery'];
