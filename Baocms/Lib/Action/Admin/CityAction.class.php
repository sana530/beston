...
class CityAction extends CommonAction {
    ...
    private $create_fields = array('name', 'pinyin','chinese_name','photo', 'is_open', 'lng', 'lat','orderby','theme','first_letter','domain');
    private $edit_fields = array('name', 'pinyin','chinese_name','photo', 'is_open', 'lng', 'lat','orderby','theme','first_letter','domain');
    ...
    private function createCheck() {
        ...
        } $data['chinese_name'] = htmlspecialchars($data['chinese_name']);
        if (empty($data['chinese_name'])) {
            $this->baoError('城市中文名不能为空');
        }
