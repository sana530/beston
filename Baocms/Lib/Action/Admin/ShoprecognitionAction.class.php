    ...
    public function audit($recognition_id = 0)
    {
            ...
            if (!empty($user_ids['mobile'])) {
                if ($this->_CONFIG['sms']['dxapi'] == 'bu') {
                    D('Sms')->BuSms($this->_CONFIG['site']['sitename'], 'sms_recognition', $user_ids['mobile'], array(
                    ...
                    D('Sms')->DySms($this->_CONFIG['site']['sitename'], 'sms_recognition', $user_ids['mobile'], array(
                        'shop_name' => $shops['shop_name'],
                        'name' =>$user_ids['name'],
                        'mobile' => $user_ids['mobile'],
                        'content' => $detail['content'],
