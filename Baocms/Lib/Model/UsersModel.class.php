...
class UsersModel extends CommonRelationModel{
    ...
    Protected $_link = array(
        'users_ext' => array(
            ...
            'foreign_key' => 'user_id',
            'mapping_fields' => 'money,integral,money_negative',
            'as_fields' => 'money,integral,money_negative',
    ...
    public function getUserByAccount($account){
        ...
        //$data = $this->query("SELECT * FROM ".C('DB_1ST_PREFIX')."users WHERE email = '{$account}' ");
